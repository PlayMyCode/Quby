...
(function (parse) {
    ...
    var newWordMatchBoundary = function (match) {
        ...
        var m1 = match.charCodeAt(1);
        var m2 = match.charCodeAt(2);
        var m3 = match.charCodeAt(3);
        var m4 = match.charCodeAt(4);
        var m5 = match.charCodeAt(5);
        var m6 = match.charCodeAt(6);
        var m7 = match.charCodeAt(7);
                    ...
                    if(matchType === 'number' || ((matchType === 'string' || match instanceof String) && match.length === 1)) {
                        ...
                        if(matchType === 'string' || match instanceof String) {
                            ...
                            if(match instanceof Array) {
                                var mTerminals = [];
                                var isLiteral = true;
                                var literalLength = Number.MAX_VALUE;
    ...
    var SymbolResult = (function () {
        function SymbolResult(errors, symbols, symbolIDs, symbolLength) {
            this.errors = errors;
    ...
    var bruteScan = function (parserRule, seenRules, idsFound) {
        if(seenRules[parserRule.compiledId] !== true) {
            ...
            var isOptional = parserRule.isOptional;
    ...
    var ParserRuleImplementation = (function () {
        ...
        ParserRuleImplementation.prototype.parseInner = function (input, parseInput, callback, debugCallback, name) {
            ...
            var self = this;
            var compileTime = this.compileTime;
            var start = Date.now();
        ...
        ParserRuleImplementation.prototype.parseSymbolsInner = function (inputSrc, src, name) {
            ...
            var symbols = [];
            var symbolIDs = [];
            var ignores = getIgnores(this.parseParent);
            var literals = this.compiled.literals;
            var terminals = this.compiled.terminals;
            var allTerms = ignores.concat(literals, terminals);
            var ignoresLen = ignores.length;
            var literalsLen = ignoresLen + literals.length;
            var termsLen = literalsLen + terminals.length;
            var ignoresTests = new Array(ignoresLen);
            var literalsData = new Array(literalsLen);
            var literalsMatches = new Array(literalsLen);
            var literalsType = new Array(literalsLen);
            var symbolIDToTerms = this.compiled.idToTerms;
            var postMatches = new Array(termsLen);
            var termTests = new Array(termsLen);
            var termIDs = new Array(termsLen);
            var multipleIgnores = (ignores.length > 1);
            var NO_ERROR = -1;
            var errorStart = NO_ERROR;
            var errors = [];

            for(var i = 0; i < allTerms.length; i++) {
                var term = allTerms[i];
                var test = term.testData;
...
while(j < literalsLen) {
                ...
                return new SymbolResult(errors, symbols, symbolIDs, symbolI);
            }
        };
...
(function (quby) {
    (function (ast) {
            ...
            Parameters.prototype.validate = function (v) {
                if(this.blockParam != null) {
                    if(this.errorParam != null) {
                        ...
                        if(this.blockParamPosition < this.getStmts().length) {
        ...
        var ModuleDefinition = (function (_super) {
            ...
            function ModuleDefinition(symName, statements) {
                        _super.call(this, symName);
            }
            ModuleDefinition.prototype.print = function (p) {
            };
            ModuleDefinition.prototype.validate = function (v) {
            };
            return ModuleDefinition;
        })(Syntax);
        ast.ModuleDefinition = ModuleDefinition;        
        ...
        var ClassDefinition = (function (_super) {
            ...
            function ClassDefinition(classHeader, statements) {
            ...
            ClassDefinition.prototype.getStatements = function () {
                return this.statements;
            };
            ClassDefinition.prototype.isExtensionClass = function () {
                return false;
            };
            ClassDefinition.prototype.getHeader = function () {
                return this.header;
            };
            ClassDefinition.prototype.setHeader = function (header) {
                this.header = header;
            };
            ClassDefinition.prototype.validate = function (v) {
            ...
            ClassDefinition.prototype.print = function (p) {
                return this.classValidator.printOnce(p);
            };
            ClassDefinition.prototype.getSuperCallName = function () {
        ...
        var ExtensionClassDefinition = (function (_super) {
            __extends(ExtensionClassDefinition, _super);
            function ExtensionClassDefinition(classHeader, statements) {
                var name = classHeader.getName();
                        _super.call(this, classHeader.offset, name, quby.runtime.formatClass(name));
                this.header = classHeader;
                this.statements = statements;
            }
            ExtensionClassDefinition.prototype.getStatements = function () {
                return this.statements;
            };
            ExtensionClassDefinition.prototype.isExtensionClass = function () {
                return true;
            };
            ExtensionClassDefinition.prototype.getHeader = function () {
                return this.header;
            };
            ExtensionClassDefinition.prototype.setHeader = function (header) {
                this.header = header;
            };
            ExtensionClassDefinition.prototype.print = function (p) {
                p.setCodeMode(false);
                if(this.statements !== null) {
            ...
            ExtensionClassDefinition.prototype.validate = function (v) {
            ...
            ExtensionClassDefinition.prototype.getSuperCallName = function () {
                return quby.runtime.ROOT_CLASS_CALL_NAME;
            };
            return ExtensionClassDefinition;
        })(NamedSyntax);
        ast.ExtensionClassDefinition = ExtensionClassDefinition;        
        ...
        var Function = (function (_super) {
            ...
            function Function(symName, parameters, stmtBody) {
            ...
            Function.prototype.hasParameters = function () {
                return this.parameters !== null && this.parameters.length > 0;
            };
            Function.prototype.getParameters = function () {
                return this.parameters;
            };
            Function.prototype.getNumParameters = function () {
                return (this.parameters !== null) ? this.parameters.length : 0;
            };
            Function.prototype.getStatements = function () {
                return this.stmtBody;
            };
            Function.prototype.isMethod = function () {
                return this.type !== Function.METHOD;
            };
            Function.prototype.isConstructor = function () {
                return this.type === Function.CONSTRUCTOR;
            };
            Function.prototype.isFunction = function () {
                return this.type === Function.FUNCTION;
            };
            Function.prototype.setType = function (type) {
                this.type = type;
            };
            Function.prototype.addPreVariable = function (variable) {
                this.preVariables.push(variable);
            };
            Function.prototype.validate = function (v) {
            ...
            Function.prototype.print = function (p) {
                if(!this.isMethod()) {
                    p.setCodeMode(false);
                }
            ...
            Function.prototype.printParameters = function (p) {
                p.append('(');
            ...
            Function.prototype.printBody = function (p) {
                p.append('{');
                this.printPreVars(p);
                p.flush();
                if(this.stmtBody !== null) {
            ...
            Function.prototype.printPreVars = function (p) {
                ...
                if(v.ensureInConstructor(this, "Super can only be called from within a constructor.")) {
                    ...
                    v.onEndValidate(function (v) {
                        ...
                        if(_this.superKlassVal == undefined) {
                            ...
                            if(!_this.superKlassVal.hasNew(_this)) {
                ...
                v.onEndValidate(function (v) {
                    ...
                    if(klassVal) {
                        ...
                        if((!klassVal.hasNew(_this)) || (klassVal.noNews() && _this.getNumParameters() > 0)) {
                            ...
                            _this.isExtensionClass = (klass instanceof ExtensionClassDefinition);
                        }
                    } else {
        ...
        ast.Lambda = Lambda;        
        var BalancingExpr = (function (_super) {
            __extends(BalancingExpr, _super);
            function BalancingExpr(offset, isResultBool) {
                        _super.call(this, offset, isResultBool);
                this.balanceDone = false;
                this.proxyExpr = null;
            }
            BalancingExpr.prototype.isBalanced = function (v) {
                if(this.balanceDone) {
                    return true;
                } else {
            ...
            BalancingExpr.prototype.validate = function (v) {
            ...
            BalancingExpr.prototype.print = function (p) {
                if(this.proxyExpr !== null) {
            ...
            BalancingExpr.prototype.printAsCondition = function (p) {
                if(this.proxyExpr !== null) {
            ...
            BalancingExpr.prototype.rebalance = function () {
            ...
            BalancingExpr.prototype.onRebalance = function () {
                throw new Error("rebalance is not implemented");
            };
            return BalancingExpr;
        })(Expr);        
        ...
        var SingleOp = (function (_super) {
            ...
            function SingleOp(expr, strOp, isResultBool) {
                        _super.call(this, expr.offset, isResultBool);
                this.expr = expr;
                this.strOp = strOp;
            }
            SingleOp.prototype.getPrecedence = function () {
                return 1;
            };
            SingleOp.prototype.getExpr = function () {
                return this.expr;
            };
            SingleOp.prototype.validate = function (v) {
            ...
            SingleOp.prototype.performBalanceSwap = function (newLeft, precedence) {
                return this;
            };
            return SingleOp;
        })(BalancingExpr);        
        ...
        var Not = (function (_super) {
            ...
            Not.prototype.print = function (p) {
                var temp = p.getTempVariable();
        ...
        var Op = (function (_super) {
            ...
            Op.prototype.validate = function (v) {
                if(this.isBalanced(v)) {
            ...
            Op.prototype.onRebalance = function () {
                ...
                if(right instanceof BalancingExpr) {
                    ...
                    if(right instanceof BalancingExpr) {
                        var rightP = right;
                        var intPrecedence = this.precedence;
            ...
            Op.prototype.performBalanceSwap = function (newLeft, precedence) {
                var left = this.left;
                var oldLeft;
                ...
                if(this.left instanceof BalancingExpr) {
                    if(((left)).getPrecedence() <= precedence) {
                        ...
                        return (left).performBalanceSwap(newLeft, precedence);
                    }
                } else {
                    oldLeft = this.left;
                    this.left = newLeft;
            ...
            Op.prototype.getPrecedence = function () {
        ...
        var IsInstanceOf = (function (_super) {
            __extends(IsInstanceOf, _super);
            ...
            IsInstanceOf.prototype.validate = function (v) {
        ...
        var BoolOp = (function (_super) {
            ...
            BoolOp.prototype.print = function (p) {
        ...
        var BoolOr = (function (_super) {
            ...
            BoolOr.prototype.print = function (p) {
                var temp = p.getTempVariable();
                p.appendPre('var ', temp, ';');
                p.append('(((', temp, '=');
        ...
        var BoolAnd = (function (_super) {
            ...
            BoolAnd.prototype.print = function (p) {
                var temp = p.getTempVariable();
                p.appendPre('var ', temp, ';');
                p.append('(((', temp, '=');
                this.getLeft().print(p);
        ...
        var Power = (function (_super) {
            ...
            Power.prototype.print = function (p) {
                p.append('Math.pow(');
                this.getLeft().print(p);
                p.append(',');
                this.getRight().print(p);
        ...
        var Mapping = (function (_super) {
            ...
            Mapping.prototype.print = function (p) {
                this.getLeft().print(p);
                p.append(',');
                this.getRight().print(p);
            };
        ...
        var Assignment = (function (_super) {
            ...
            Assignment.prototype.validate = function (v) {
            ...
            Assignment.prototype.print = function (p) {
        ...
        var Identifier = (function (_super) {
            ...
            function Identifier(identifier, callName) {
                        _super.call(this, identifier, identifier.match, callName);
                this.isAssignmentFlag = false;
            }
            Identifier.prototype.isAssignment = function () {
                return this.isAssignmentFlag;
            };
            Identifier.prototype.print = function (p) {
                p.append(this.getCallName());
            };
            Identifier.prototype.setAssignment = function (v, parent) {
        ...
        var ArrayDefinition = (function (_super) {
            __extends(ArrayDefinition, _super);
            function ArrayDefinition(parameters) {
                var offset;
                if(parameters) {
            ...
            ArrayDefinition.prototype.getParameters = function () {
                return this.parameters;
            };
            ArrayDefinition.prototype.print = function (p) {
            ...
            ArrayDefinition.prototype.validate = function (v) {
                if(this.parameters !== null) {
                    this.parameters.validate(v);
                }
            };
        ...
        ast.ArrayDefinition = ArrayDefinition;        
        var HashDefinition = (function (_super) {
            __extends(HashDefinition, _super);
            function HashDefinition(parameters) {
                        _super.call(this, parameters);
            }
            HashDefinition.prototype.print = function (p) {
        ...
        ast.HashDefinition = HashDefinition;        
        var Literal = (function (_super) {
            __extends(Literal, _super);
            function Literal(sym, isTrue, altMatch) {
                var match = altMatch ? altMatch : sym.match;
                        _super.call(this, sym);
                this.isTrue = isTrue;
            }
...
(function (quby) {
    (function (core) {
        var STATEMENT_END = ';\n';
        function runParser(instance, validator) {
            instance.lock();
        ...
        var Validator = (function () {
            ...
            Validator.prototype.isInsideClassDefinition = function () {
            ...
            Validator.prototype.useFun = function (funCall) {
                if(funCall.isMethod()) {
                    ...
                    if(this.isInsideClass()) {
                        ...
                        if(!this.funs[funCall.getCallName()]) {
                ...
                if(!quby.compilation.hints.useMethodMissing()) {
                    ...
                    this.methodNames.callNames(function (callName) {
                        if(rootKlass === null || !rootKlass.hasFunCallName(callName)) {
                            ...
                            extensionStr[extensionStr.length] = [
                                '.prototype.', 
                                callName, 
                                '=', 
                                quby.runtime.FUNCTION_DEFAULT_TABLE_NAME, 
                                '.', 
                                callName
                            ].join('');
                        }
        ...
        var LateFunctionBinder = (function () {
            ...
            LateFunctionBinder.prototype.addFun = function (fun) {
                ...
                var innerFuns = funs[funCallName];
        ...
        var ClassValidator = (function () {
            ...
            ClassValidator.prototype.endValidate = function () {
                ...
                if(this.news.length == 0 && !this.klass.isExtensionClass) {
                    var constructor = new quby.ast.Constructor(thisKlass.offset.clone("new"), null, null);
    ...
    (function (main) {
        ...
        var Parser = (function () {
            ...
            Parser.prototype.parseUrl = function (url) {
                ...
                var validator = this.validator;
                var name = util.url.stripDomain(url);
                var questionMark = name.indexOf('?');
...
(function (quby) {
    (function (parser) {
                                    ...
                                    if(inSingleComment) {
                                        ...
                                        if(multiCommentCount > 0) {
                                            if(c === SLASH && getRight(src, i) === STAR) {
                                                ...
                                                if(c === STAR && getRight(src, i) === SLASH) {
                                                    multiCommentCount--;
                                                    i++;
                                                    if(multiCommentCount === 0) {
                                            ...
                                            if(c === SLASH && getRight(src, i) === STAR) {
                                                ...
                                                if(c === SLASH && getRight(src, i) === SLASH) {
                                                    newSrc.push(src.substring(startI, i));
                                                    startI = i;
                                                        ...
                                                        if(c === SINGLE_QUOTE) {
                                                            ...
                                                            if(c === HASH) {
                                                                if(getR(src, i + 1) === LESS_THAN && getR(src, i + 2) === HASH) {
                                                                    ...
                                                                    if(getR(src, i + 1) === LESS_THAN && getR(src, i + 2) === LOWER_P && getR(src, i + 3) === LOWER_R && getR(src, i + 4) === LOWER_E && getR(src, i + 5) === HASH) {
                                                                        inPreAdmin = true;
                                                                        i += 5;
                                                                    }
                                                                }
                    ...
                    if(code === HASH && src.charCodeAt(i + 1) === LESS_THAN && src.charCodeAt(i + 2) === HASH) {
                        ...
                        do {
                            ...
                            if(code === HASH) {
                                ...
                                if(code === GREATER_THAN && src.charCodeAt(i - 1) === HASH && src.charCodeAt(i + 1) === HASH) {
                                    return i + 2;
                                }
                            }
                        }while(i < len)
        ...
        var statementSeperator = parse.either(terminals.endOfLine, terminals.endOfStatement);
        var statement = parse.rule();
        var expr = parse.rule();

        var repeatStatement = parse.repeatSeperator(statement, statementSeperator);
        var statements = parse.optional(statementSeperator).optional(repeatStatement).optional(statementSeperator).onMatch(function (onStart, stmts, endEnd) {
            if(stmts === null) {
        ...
        var exprs = parse.repeatSeperator(expr, terminals.symbols.comma).onMatch(function (exprs) {
        ...
        var variables = parse.either(terminals.identifiers, terminals.keywords.THIS, parse.a(terminals.ops.hash).either(terminals.identifiers.variableName, terminals.identifiers.global).onMatch(function (hash, name) {
            ...
            if(term === terminals.identifiers.variableName) {
                ...
                if(term === terminals.identifiers.global) {
                    return new quby.ast.GlobalVariable(identifier);
                } else {
                    if(term === terminals.identifiers.objectField) {
                        return new quby.ast.FieldVariable(identifier);
                    } else {
                        if(term === terminals.keywords.THIS) {
                            return new quby.ast.ThisVariable(identifier);
                        } else {
                            if(identifier instanceof quby.ast.JSVariable) {
                                return identifier;
                            } else {
                                log(identifier);
        ...
        var arrayAccessExtension = parse.a(terminals.symbols.leftSquare, expr).optional(terminals.endOfLine).then(terminals.symbols.rightSquare).onMatch(function (leftSquare, keyExpr, endOfLine, rightSquare) {
            return new quby.ast.ArrayAccess(null, keyExpr);
        });
        var singleOpExpr = parse.either(terminals.ops.plus, terminals.ops.subtract, terminals.ops.not).then(expr).onMatch(function (op, expr) {
            var term = op.terminal;
            if(term === ops.not) {
                return new quby.ast.Not(expr);
            } else {
                if(term === ops.subtract) {
        ...
        var arrayDefinition = parse.a(terminals.symbols.leftSquare).optional(exprs).optional(terminals.endOfLine).then(terminals.symbols.rightSquare).onMatch(function (lSquare, exprs, endOfLine, rSquare) {
            if(exprs !== null) {
        ...
        var hashMapping = parse.a(expr).either(terminals.ops.colon, terminals.ops.mapArrow).then(expr).onMatch(function (left, mapAssign, right) {
            return new quby.ast.Mapping(left, right);
        });
        var hashDefinition = parse.a(terminals.symbols.leftBrace).optionalSeperator(hashMapping, terminals.symbols.comma).optional(terminals.endOfLine).then(terminals.symbols.rightBrace).onMatch(function (lBrace, mappings, endOfLine, rBrace) {
            if(mappings !== null) {
                return new quby.ast.HashDefinition(new quby.ast.Mappings(mappings));
            } else {
                return new quby.ast.HashDefinition();
            }
        });
        var yieldExpr = parse.a(terminals.keywords.YIELD).optional(exprs).onMatch(function (yld, exprs) {
            if(exprs !== null) {
        ...
        var returnStatement = parse.a(terminals.keywords.RETURN).optional(expr).onMatch(function (rtn, expr) {
            if(expr !== null) {
        ...
        var parameterDefinition = parse.a(terminals.symbols.leftBracket).optional(parameterFields).optional(terminals.endOfLine).then(terminals.symbols.rightBracket).onMatch(function (lParen, params, end, rParen) {
            if(params === null) {
        ...
        var parameterExprs = parse.a(terminals.symbols.leftBracket).optional(exprs).optional(terminals.endOfLine).then(terminals.symbols.rightBracket).onMatch(function (lParen, exprs, end, rParen) {
            if(exprs !== null) {
                return exprs;
            } else {
                return null;
        ...
        var blockParams = parse.a(terminals.ops.bitwiseOr).optional(blockParamVariables).optional(terminals.endOfLine).then(terminals.ops.bitwiseOr).onMatch(function (lOr, params, end, rOr) {
            if(params !== null) {
                return new quby.ast.Parameters(params);
            } else {
                return null;
        ...
        var block = parse.either(terminals.symbols.leftBrace, terminals.keywords.DO).optional(blockParams).optional(statements).thenEither(terminals.symbols.rightBrace, terminals.keywords.END).onMatch(function (lBrace, params, stmts, rBrace) {
        ...
        var lambda = parse.a(terminals.keywords.DEF, parameterDefinition).optional(statements).then(terminals.keywords.END).onMatch(function (def, params, stmts, end) {
            return new quby.ast.Lambda(params, stmts);
        });
        var functionCall = parse.a(terminals.identifiers.variableName).then(parameterExprs).optional(block).onMatch(function (name, exprs, block) {
        ...
        var newInstance = parse.a(terminals.keywords.NEW).either(parse.a(terminals.ops.hash).then(expr).then(parameterExprs).optional(block).onMatch(function (hash, expr, params, block) {
        ...
        }), parse.either(ops.plus, ops.subtract, ops.divide, ops.multiply, ops.logicalAnd, ops.logicalOr, ops.equal, ops.notEqual, ops.modulus, ops.lessThan, ops.greaterThan, ops.lessThanEqual, ops.greaterThanEqual, ops.shiftLeft, ops.shiftRight, ops.bitwiseAnd, ops.bitwiseOr, ops.is, ops.power, ops.assignment).then(expr).onMatch(function (op, right) {
            var term = op.terminal;
        ...
        expr.either(singleOpExpr, arrayDefinition, hashDefinition, yieldExpr, exprInParenthesis, newInstance, functionCall, variables, lambda, terminals.literals, terminals.admin.inline, terminals.admin.preInline).optional(exprExtension).onMatch(function (expr, rest) {
            if(rest !== null) {
        ...
        var classHeader = parse.a(terminals.identifiers.variableName).optional(parse.a(terminals.ops.lessThan, terminals.identifiers.variableName).onMatch(function (lessThan, superClass) {
            return superClass;
        })).onMatch(function (name, superClass) {
            return new quby.ast.ClassHeader(name, superClass);
        });
        var moduleDefinition = parse.a(terminals.keywords.MODULE).then(terminals.identifiers.variableName).optional(statements).then(terminals.keywords.END).onMatch(function (keyModule, name, stmts, end) {
            return new quby.ast.ModuleDefinition(name, stmts);
        });
        var classDefinition = parse.a(terminals.keywords.CLASS).then(classHeader).optional(statements).then(terminals.keywords.END).onMatch(function (klass, header, stmts, end) {
            return new quby.ast.ClassDefinition(header, stmts);
        });
        var functionDefinition = parse.either(terminals.keywords.DEF, terminals.admin.hashDef).thenEither(terminals.keywords.NEW, terminals.identifiers.variableName).then(parameterDefinition).optional(statements).then(terminals.keywords.END).onMatch(function (def, name, params, stmts, end) {
        ...
        var ifStart = parse.a(terminals.keywords.IF).then(expr).optional(terminals.keywords.THEN).then(statements).onMatch(function (IF, condition, THEN, stmts) {
            return new quby.ast.IfBlock(condition, stmts);
        });
        var ifElseIf = parse.either(terminals.keywords.ELSE_IF, terminals.keywords.ELSEIF, terminals.keywords.ELSIF).then(expr).optional(terminals.keywords.THEN).then(statements).onMatch(function (elseIf, condition, then, stmts) {
            return new quby.ast.IfBlock(condition, stmts);
        });
        var ifElseIfs = parse.repeat(ifElseIf).onMatch(function (elseIfs) {
            return new quby.ast.IfElseIfs(elseIfs);
        });
        var elseClause = parse.a(terminals.keywords.ELSE, statements).onMatch(function (els, stmts) {
            return stmts;
        });
        var ifStatement = parse.a(ifStart).optional(ifElseIfs).optional(elseClause).then(terminals.keywords.END).onMatch(function (start, otherIfs, elses, end) {
            return new quby.ast.IfStmt(start, otherIfs, elses);
        });
        var whileUntilStatement = parse.either(terminals.keywords.WHILE, terminals.keywords.UNTIL).then(expr, statements).then(terminals.keywords.END).onMatch(function (whileUntil, expr, stmts, end) {
        ...
        var loopStatement = parse.a(terminals.keywords.LOOP).then(statements).then(terminals.keywords.END).either(terminals.keywords.WHILE, terminals.keywords.UNTIL).then(expr).onMatch(function (loop, stmts, end, whileUntil, expr) {
            if(whileUntil.terminal === terminals.keywords.WHILE) {
        ...
        var whenStatement = parse.a(terminals.keywords.WHEN).then(exprs).thenEither(terminals.keywords.THEN, statementSeperator).then(statements).onMatch(function (when, exprs, seperator, statements) {
            return new quby.ast.WhenClause(exprs, statements);
        });
        var whenStatements = parse.repeat(whenStatement);
        var caseWhenStatement = parse.a(terminals.keywords.CASE).optional(expr).optional(whenStatements).optional(elseClause).then(terminals.keywords.END).onMatch(function (caseTerm, expr, whenClauses, elseClause, end) {
            return new quby.ast.CaseWhen(caseTerm, expr, whenClauses, elseClause);
        });
        statement.either(functionDefinition, classDefinition, moduleDefinition, ifStatement, whileUntilStatement, loopStatement, caseWhenStatement, returnStatement, expr, terminals.admin.inline, terminals.admin.preInline);
...
(function (quby) {
    (function (runtime) {
        runtime.FUNCTION_DEFAULT_TABLE_NAME = '_q_no_funs';
        runtime.FUNCTION_TABLE_NAME = '_q_funs';
        runtime.SUPER_KEYWORD = "super";
        runtime.EXCEPTION_NAME_RUNTIME = "Runtime Error";
        runtime.TRANSLATE_CLASSES = {
            'array': 'QubyArray',
            'hash': 'QubyHash',
            'object': 'QubyObject'
        };
        runtime.BLOCK_VARIABLE = '_q_block';
        runtime.TEMP_VARIABLE = '_t';
        runtime.VARIABLE_PREFIX = '_var_';
        runtime.FIELD_PREFIX = '_field_';
        runtime.GLOBAL_PREFIX = '_global_';
        runtime.FUNCTION_PREFIX = '_fun_';
        runtime.CLASS_PREFIX = '_class_';
        runtime.NEW_PREFIX = '_new_';
        runtime.SYMBOL_PREFIX = '_sym_';
        runtime.ROOT_CLASS_NAME = 'object';
        runtime.ROOT_CLASS_CALL_NAME = null;
        runtime.FIELD_NAME_SEPERATOR = '@';
        ...
        function unformatString(str) {
            str = str.replace(/\b[a-zA-Z0-9_]+\b/g, function (match) {
                if(match.indexOf(quby.runtime.FUNCTION_PREFIX) === 0) {
                    ...
                    if((match.indexOf(quby.runtime.FIELD_PREFIX) === 0) && match.indexOf(quby.runtime.FIELD_PREFIX, 1) > -1) {
                        ...
                        var fieldBit = match.substring(secondFieldPrefixI + quby.runtime.FIELD_PREFIX.length);
                        ...
                        if(match.indexOf(quby.runtime.CLASS_PREFIX) === 0) {
                            ...
                            if(match.indexOf(quby.runtime.GLOBAL_PREFIX) === 0) {
                                return '$' + match.substring(quby.runtime.GLOBAL_PREFIX.length);
                            } else {
                                if(match.indexOf(quby.runtime.SYMBOL_PREFIX) === 0) {
                                    return ':' + match.substring(quby.runtime.SYMBOL_PREFIX.length);
                                } else {
                                    if(match.indexOf(quby.runtime.VARIABLE_PREFIX) === 0) {
            ...
            var qubyArrTranslation = function (str, prefixPattern, onFind) {
                ...
                while((i = str.indexOf(prefixPattern)) > -1) {
                    ...
                    var mid = str.substring(openingI, closingI);
                    var post = str.substring(closingI + 1);
