...
module quby {
    export module main {
         ...
         */
        export function runScriptTags(onResult) {
            if (!onResult) {
         ...
         *
         */
        export function parse(source, adminMode, callback) {
            var parser = new Parser();
        ...
        export class ParserInstance {
            ...
            private whenFinished = null;
            private debugCallback = null;

            private strName = '<Unknown Script>';

            private isExplicitelyNamed = false;
        ...
        export class Parser {
            ...
            parseArgs(source: string, adminMode: bool, callback, debugCallback) {
                return this.
                        parse(source).
                        adminMode(adminMode).
                        finish(callback).
        ...
        export class Result {
            ...
            constructor(program: string, errors) {
