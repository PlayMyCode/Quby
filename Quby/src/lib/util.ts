...
export module util {
    ...
    export function klass( init: () => any, ...funs: any[] ) {
...
export module util.ajax {
    ...
    export function postFuture( url, callback, data, isBlocking, timestamp ) {
    ...
    export function get( url, callback, data, isBlocking, timestamp ) {
        return util.ajax.call(
                'GET',
                url,
                callback,
    ...
    export function getFuture( url, callback, data, isBlocking, timestamp ) {
        var tag = util.future.block( function( status, text, xml ) {
            callback( status, text, xml );
        } );
    ...
    export function call( method:string, url:string, callback, passData:string = '', async:bool = true, timestamp:bool = false ) {
