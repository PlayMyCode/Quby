...
(function (quby) {
    (function (ast) {
        ...
        ast.BalancingExpr = BalancingExpr;        
        ...
        var Op = (function (_super) {
            ...
            Op.prototype.onRebalance = function () {
                ...
                if(right instanceof BalancingExpr) {
                    ...
                    if(right instanceof BalancingExpr) {
                        var rightP = right, intPrecedence = this.precedence;
        ...
        var ArrayLiteral = (function (_super) {
            ...
            function ArrayLiteral(parameters) {
                var offset;
                if(parameters) {
            ...
            ArrayLiteral.prototype.getParameters = function () {
                return this.parameters;
            };
            ArrayLiteral.prototype.print = function (p) {
            ...
            ArrayLiteral.prototype.validate = function (v) {
                if(this.parameters !== null) {
                    this.parameters.validate(v);
                }
            };
        ...
        var HashLiteral = (function (_super) {
            ...
            HashLiteral.prototype.print = function (p) {
...
(function (quby) {
    (function (parser) {
        ...
        var exprs = parse.repeatSeperator(expr, terminals.symbols.comma).name('expressions').onMatch(function (exprs) {
        ...
        var arrayLiteral = parse.name('new Array').a(terminals.symbols.leftSquare).optional(exprs).optional(terminals.endOfLine).then(terminals.symbols.rightSquare).onMatch(function (lSquare, exprs, endOfLine, rSquare) {
            if(exprs !== null) {
        ...
        var hashLiteral = parse.name('new Hash').a(terminals.symbols.leftBrace).optionalSeperator(hashMapping, terminals.symbols.comma).optional(terminals.endOfLine).then(terminals.symbols.rightBrace).onMatch(function (lBrace, mappings, endOfLine, rBrace) {
            if(mappings !== null) {
                return new quby.ast.HashLiteral(new quby.ast.Mappings(mappings));
            } else {
        ...
        var parameterDefinition = parse.name('parameters').a(terminals.symbols.leftBracket).optional(parameterFields).optional(terminals.endOfLine).then(terminals.symbols.rightBracket).onMatch(function (lParen, params, end, rParen) {
            if(params === null) {
                                                                        ...
                                                                        if(term === ops.shiftRight) {
                                                                            ...
                                                                            if(term === ops.bitwiseAnd) {
                                                                                ...
                                                                                if(term === ops.bitwiseOr) {
                                                                                    ...
                                                                                    if(term === terminals.admin.jsInstanceOf) {
        ...
        statement.either(functionDeclaration, classDeclaration, moduleDeclaration, ifStatement, whileUntilStatement, loopStatement, caseWhenStatement, returnStatement, expr, terminals.admin.inline, terminals.admin.preInline);
